...
public class RideController {
	...
	public @ResponseBody Object test() {
	    //This is abstract so creating an anonymous class implementation
	    DataAccessException dae = new DataAccessException("DAE Testing exception thrown") {
        };
        throw dae;
	}
	...
	public ResponseEntity<ServiceError> handle(RuntimeException ex)
	{
	    ...
	    return new ResponseEntity<ServiceError>(se, HttpStatus.OK);
	}
