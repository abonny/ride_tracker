...
public class RestControllerTest {
	...
	public void testDelete() {
	    RestTemplate restTemplate = new RestTemplate();
	    restTemplate.delete("http://localhost:8080/ride_tracker/delete/8");
	}
	
	@Test(timeout = 33000)
	public void testException() {
	    RestTemplate restTemplate = new RestTemplate();
	    Ride responseBodyError = restTemplate.getForObject("http://localhost:8080/ride_tracker/test", Ride.class);
	}
